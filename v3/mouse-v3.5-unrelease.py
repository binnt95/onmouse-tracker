...
def main():
	...
	print(f"Logo Copyright (c) Mojang Studios 2009 - {c_year}")
	time.sleep(secs)
	pygame.init()
	secs = 2
	runtime = True
	...
	APP_NAME = f"Mouse Pad {WIDTH}x{HEIGHT} [{VERSION}] {str(VERSION)[0]}{getnum_s(str(VERSION)[0])} gen"
	fnts = 26
	x = WIDTH / 6
	y = 10
	y2 = 40
